...
const steps = [
  {
    ...
    description:
      'Select the cultural event, holiday, or trend you want to target from our extensive library.',
  },
  {
    icon: (
      <svg
    ...
    description:
      'Our AI drafts copy and generates images tailored to local nuances and language specifics.',
  },
  {
    icon: (
      <svg
    ...
    title: '3. Publish',
    description:
      'Tweak the results to match your brand voice perfectly and export directly to social media.',
  },
]
        ...
        <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="max-w-2xl">
            <h2 className="how-it-works-title text-slate-900 dark:text-white text-3xl font-bold leading-tight tracking-tight mb-4">
              From Idea to Localized Content
            </h2>
            <p className="how-it-works-title text-slate-600 dark:text-slate-400 text-lg">
              Generate content that resonates with your audience in three simple
              steps.
            </p>
          </div>
        </div>
